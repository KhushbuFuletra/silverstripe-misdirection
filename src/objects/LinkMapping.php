...
class LinkMapping extends DataObject
{
    ...
    public function getCMSFields()
    {
        ...
        Requirements::css('symbiote/silverstripe-misdirection: client/css/misdirection.css');
        ...
        if ($this->canEdit()) {
            Requirements::javascript('symbiote/silverstripe-misdirection: client/javascript/misdirection-link-mapping.js');
